...
use test_shopasis;
add jar /home/hadoop/mikai/hiveudf.jar;
...
where log_day = '$datelong' and index = '1' and t = '0' and i = '1' and u is not null and u!='null' and u<>'';
	...
	lateral view getshopinfo(ru,u,1) si as ptId,stId,shopId,productId,skuId;
...
from (select * from temp_shopwebdata_3 where shopId == 0) a left outer join default.afcusdw_0_live_catb_0_gome_product_shop b
