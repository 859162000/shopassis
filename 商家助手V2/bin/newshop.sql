...
where a.log_day = '20150512' and a.index = '1' and a.t = '0' and a.i in ('1','2') and a.u is not null and a.u<>'' and si.stId >= 1 and si.ptId >= 1;
...
select i,shopId,s,min(new_time) orgin_time,count(1) pv,IF(count(1) == 1,1,0) jumps,
...
on a.i = b.i and a.shopId = b.shopId and a.s = b.s and a.orgin_time = b.new_time;
)
