...
public class ExplodeMapOrders extends GenericUDTF {
    ...
    public void process(Object[] args) throws HiveException {
        // order_time,order_id,order_money,channels,log_times
        String order_time = args[0].toString();
        String order_id = args[1].toString();
        String order_money = args[2].toString();
        String channel = args[3].toString();
        String log_time = args[4].toString();
        ...
        try {
            for (int i = 0; i < channels.length; i++) {
                ...
                if (haschannel.size() == 0) {
                    results[0] = order_id;
                    results[1] = order_money;
                    results[2] = channels[i];
                    results[3] = "1";
                    results[4] = "0";
                    results[5] = Long.toString(diffDays);
